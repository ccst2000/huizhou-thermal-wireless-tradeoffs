...
la.to_csv("data/lst_abs_composite_v5.csv", index=False)

# 汇总进 stats_v5
import json
with open("data/stats_v5.json", encoding="utf-8") as f:
    S = json.load(f)
